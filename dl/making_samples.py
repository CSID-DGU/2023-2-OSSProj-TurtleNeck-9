...
ISE.insert_last(subj_name="경영과학1",grade=22);ISE.insert_last("데이터분석입문",grade=22,prev_subj_nec_names=["응용통계학"]);ISE.insert_last(subj_name="정보시스템분석설계",grade=22);ISE.insert_last(subj_name="산학융합종합설계",grade=22)
...
EE1.grade2names={11:["어드벤처디자인"],12:["공학프로그램응용","어드벤처디자인"],
                 ...
                 22:["산학융합종합설계","디지털실험","객체지향프로그래밍","신호및시스템","논리회로설계","회로이론2"],
...
EE2.grade2names={11:["어드벤처디자인"],12:["공학프로그램응용","어드벤처디자인"],
                 ...
                 22:["산학융합종합설계","디지털실험","신호및시스템","전자기학2","물리전자공학2","회로이론2"],
...
EE2.insert_last(subj_name="산학융합종합설계",grade=22);EE2.insert_last(subj_name="회로이론2",grade=22,prev_subj_nec_names=["회로이론1"]);EE2.insert_last(subj_name="전자기학2",grade=22,prev_subj_nec_names=["전자기학1"]);EE2.insert_last(subj_name="신호및시스템",grade=22,prev_subj_rec_names=["C언어및자료구조"]);EE2.insert_last(subj_name="물리전자공학2",grade=22,prev_subj_nec_names=["물리전자공학1"]);EE2.insert_last(subj_name="디지털실험",grade=22,prev_subj_rec_names=["디지털공학"])
...
EE3.grade2names={11:["어드벤처디자인"],12:["공학프로그램응용","어드벤처디자인"],
                 ...
                 22:["산학융합종합설계","디지털실험","신호및시스템","논리회로설계","전자기학2","회로이론2"],
...
EE3.insert_last(subj_name="산학융합종합설계",grade=22);EE3.insert_last(subj_name="회로이론2",grade=22,prev_subj_nec_names=["회로이론1"]);EE3.insert_last(subj_name="디지털실험",grade=22,prev_subj_rec_names=["디지털공학"]);EE3.insert_last(subj_name="논리회로설계",grade=22,prev_subj_rec_names=["디지털공학"]);EE3.insert_last(subj_name="전자기학2",grade=22,prev_subj_nec_names=["전자기학1"]);EE3.insert_last(subj_name="신호및시스템",grade=22)
...
EE4.grade2names={11:["어드벤처디자인"],12:["공학프로그램응용","어드벤처디자인"],
                 21:["전기회로실험","C언어및자료구조","디지털공학","전자기학1","물리전자공학1","회로이론1"],
                 22:["산학융합종합설계","객체지향프로그래밍","신호및시스템","논리회로설계","전자기학2","물리전자공학2","회로이론2"],
...
EE4.insert_last(subj_name="산학융합종합설계",grade=22);EE4.insert_last(subj_name="회로이론2",grade=22,prev_subj_nec_names=["회로이론1"]);EE4.insert_last(subj_name="전자기학2",grade=22,prev_subj_nec_names=["전자기학1"]);EE4.insert_last(subj_name="신호및시스템",grade=22,prev_subj_rec_names=["공학프로그램응용"]);EE4.insert_last(subj_name="객체지향프로그래밍",grade=22,prev_subj_rec_names=["C언어및자료구조"]);EE4.insert_last(subj_name="논리회로설계",grade=22,prev_subj_nec_names=["디지털공학"]);EE4.insert_last(subj_name="물리전자공학2",grade=22,prev_subj_nec_names=["물리전자공학1"])
...
EE5.grade2names={11:["어드벤처디자인"],12:["어드벤처디자인"],
                 ...
                 22:["산학융합종합설계","디지털실험","논리회로설계","전자기학2","물리전자공학2","회로이론2"],
...
EE6.grade2names={11:["어드벤처디자인"],12:["어드벤처디자인","공학프로그램응용"],
                 ...
                 22:["산학융합종합설계","객체지향프로그래밍","전자기학2","물리전자공학2","회로이론2"],
...
EE7.insert_last(subj_name="산학융합종합설계",grade=22);EE7.insert_last(subj_name="회로이론2",grade=22,prev_subj_nec_names=["회로이론1"]);EE7.insert_last(subj_name="전자기학2",grade=22,prev_subj_nec_names=["회로이론1"]);EE7.insert_last(subj_name="물리전자공학2",grade=22,prev_subj_nec_names=["물리전자공학1"]);EE7.insert_last(subj_name="객체지향프로그래밍",grade=22,prev_subj_rec_names=["C언어및자료구조"])
