...
#산업시스템공학과 이수체계도 만들기
#참고 : insert_last 안 한 경우, tail 추력하며 rand.randrange에서 에러나는 경우가 나오는데, 어떤 과목을 안했는지 알고 싶으면, search_randomsubj_by_grade메서드의 print부분 잘 보기(selected_subj_nodes 이름 이상하게 나온 것이 바로 insert 안 한 거)
...
ISE.insert_last(subj_name="경영과학2",grade=31,prev_subj_nec_names=["응용통계학"]);ISE.insert_last(subj_name="실험계획법",grade=31,prev_subj_nec_names=["응용통계학"]);ISE.insert_last(subj_name="머신러닝1",grade=31,prev_subj_rec_names=["데이터분석입문"],Sim_Subj=["머신러닝과데이터사이언스","머신러닝","기계학습"]);ISE.insert_last(subj_name="생산및운영관리",grade=31);ISE.insert_last(subj_name="금융공학입문",grade=31,prev_subj_nec_names=["응용통계학"],Sim_Subj=["금융수학","금융론"])
ISE.insert_last(subj_name="품질공학",grade=32,prev_subj_nec_names=["응용통계학"]);ISE.insert_last(subj_name="첨단제조공학",grade=32);ISE.insert_last(subj_name="머신러닝2",grade=32,prev_subj_rec_names=["머신러닝1"],Sim_Subj=["심층기계학습","기계학습론"]);ISE.insert_last(subj_name="기술경영",grade=32,prev_subj_nec_names=["응용통계학"]);ISE.insert_last(subj_name="유통물류관리",grade=32,prev_subj_nec_names=["생산및운영관리","경영과학1"]);ISE.insert_last(subj_name="헬스케어공학",grade=32,prev_subj_rec_names=["인간공학"]);ISE.insert_last(subj_name="산업시스템프로그래밍2",grade=32,prev_subj_rec_names=["산업시스템프로그래밍1"])
...
EE=study_system()#EE=Electronical Engineering(멀티미디어 콘텐츠 및 신호처리 트랙)
...
"""#name2id와 grade2names간 데이터 서로 맞는지 확인한 것(전부 고쳤음)
print(EE.name2id.keys())
all_class=[]
#print(EE.grade2names.items())
for names in EE.grade2names.items():
#    print(names)
    all_class.extend(names[1])
#print(all_class)
Existence="Yes"
for name in EE.name2id.keys():
...
print("센서응용공학 등록 여부 : ","센서응용공학" in EE1.name2id.keys())
"""
EE1=study_system()#EE=Electronical Engineering(멀티미디어 콘텐츠 및 신호처리 트랙)
EE1.name2id={"회로이론1":"ENE2002","디지털공학":"ENE2003","물리전자공학1":"ENE2005","전자기학1":"ENE2006","전기회로실험":"ENE2007","회로이론2":"ENE2008","논리회로설계":"ENE2009","물리전자공학2":"ENE2011","전자기학2":"ENE2012","디지털실험":"ENE2013","C언어및자료구조":"ENE2015","신호및시스템":"ENE2016","공학프로그램응용":"ENE2017","객체지향프로그래밍":"ENE2018","어드벤처디자인":"ENE2019","마이크로프로세서응용및실험":"ENE4002","고체전자소자":"ENE4004","전력공학1":"ENE4006","전기기계1":"ENE4007","전기전자재료공학":"ENE4008","컴퓨터구조및설계":"ENE4010","디지털신호처리및설계":"ENE4014","전력공학2":"ENE4016","전기기계2":"ENE4017","고전압공학":"ENE4018","SoC설계":"ENE4019","광전자공학":"ENE4024","디지털집적회로설계":"ENE4025","전력전자공학":"ENE4026","전자에너지변환공학":"ENE4027","로봇공학":"ENE4031","반도체공정":"ENE4033","전동력제어및응용":"ENE4035","캡스톤디자인":"ENE4039","랜덤신호이론":"ENE4044","전자회로2":"ENE4045","통신이론":"ENE4046","전기응용":"ENE4049","나노전자기계공학":"ENE4050","전력시스템응용":"ENE4054","분산전원시스템":"ENE4055","신재생에너지":"ENE4056","영상및딥러닝프로그래밍":"ENE4059","영상처리":"ENE4060","디지털통신":"ENE4061","기계학습론":"ENE4062","전자회로1":"ENE4063","전자회로실험":"ENE4064","제어공학개론":"ENE4066","현대제어공학":"ENE4067","아날로그집적회로":"ENE4068","임베디드신호처리시스템":"ENE4069","초고주파공학":"ENE4070","안테나공학":"ENE4071","IoT통신및실습":"ENE4072","전기설비공학개론":"ENE4073","센서응용공학":"ENE4074"}
#grade2names에는 각 루트 name만 들어가야 하기에, EE루트마다 insertlast한 것만 남겨야됨!
...
#EE1.insert_last(subj_name="회로이론1",grade=21,prev_subj_rec_names=["전기회로실험"]) -> 이렇게 하면, 전기회로실험의 node는 없기에 self.tail이 prev_rec으로 연결되어 오류남!
...
EE2=study_system()#EE=Electronical Engineering(통신 및 전자파 트랙)
...
EE3=study_system()#EE=Electronical Engineering(디지털 시스템 및 전자응용 트랙)
...
EE4=study_system()#EE=Electronical Engineering(소프트웨어 및 신호 트랙)
...
EE5=study_system()#EE=Electronical Engineering(마이크로 전자공학 트랙)
...
EE6=study_system()#EE=Electronical Engineering(전력계통 및 신재생에너지 트랙)
...
EE7=study_system()#EE=Electronical Engineering(전력 변환 시스템 트랙)
...
#각 데이터 셋 똑바로 만들어졌는지를 데이터 개수로 간접적 확인
print("엑셀에 넣을 전전 샘플 개수:",len(AllsamplesEE_excel))#위에서 만든 sample 개수 총합과 같아야됨(2100)
print("엑셀에 넣을 산시 샘플 개수:",len(AllsamplesISE_excel))
    #Excel로 데이터 다시 만들 때만 이 주석처리 빼기
"""
Excel_data_set = []
...
"""
#전전, 산시 각각 과목 수 차이 많이 나는지 확인
import matplotlib.pyplot as plt
print('수강한 최대 과목수 :',max(len(sample_list) for sample_list in AllsamplesEE))
print('수강한 평균 과목수 :',sum(map(len, AllsamplesEE))/len(AllsamplesEE))
plt.hist([len(sample_list) for sample_list in AllsamplesEE], bins=50)
plt.xlabel('들은 과목수(=문장 길이)') 
plt.ylabel('샘플 수(=학생 수)')
plt.show()

print('수강한 최대 과목수 :',max(len(sample_list) for sample_list in AllsamplesISE))
print('수강한 평균 과목수 :',sum(map(len, AllsamplesISE))/len(AllsamplesISE))
plt.hist([len(sample_list) for sample_list in AllsamplesISE], bins=50)
plt.xlabel('들은 과목수(=문장 길이)') 
plt.ylabel('샘플 수(=학생 수)')
plt.show()#그렇게 차이 안 남을 확인 가능
"""